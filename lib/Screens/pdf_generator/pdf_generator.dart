                      ...
                      child: pw.Column(children: [
                        ...
                        for (int i = 0;
                          ...
                          for (int j = 0;
                              ...
                              j++)
                            bulletItem(
                                '${patientsVisitData.examination.data[i].parameters[j].title} '
                                '${patientsVisitData.examination.data[i].parameters[j].result != null && patientsVisitData.examination.data[i].parameters[j].result.isNotEmpty ? '${patientsVisitData.examination.data[i].parameters[j].result[0]} ${patientsVisitData.examination.data[i].parameters[j].unit}' : ''}',
