...
class PatientVisitDialog extends StatefulWidget {
  ...
  const PatientVisitDialog({Key key, this.token, this.pat, this.pd})
      : super(key: key);
                      ...
                      return Column(
                          ...
                          children: [
                            ...
                            /*Padding(
                              ...
                              child: Center(
                                child: Text("Noticeable",
                                    textAlign: TextAlign.center,
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold)),
                              ),
                            ),
                            if (widget.pd.isNotEmpty)
                            Wrap(
                              ...
                              children: [
                                ...
                                int.parse(widget.pd.last.bp.split('/')[0]) >
                                    ...
                                    : Container(),
                                (widget.pd.last.pulse != null &&
                                        widget.pd.last.pulse != "")
                                    ? int.parse(widget.pd.last.pulse) > 100 ||
                                        ...
                                        : Container()
                                    : Container(),
                                (widget.pd.last.weight != null &&
                                        widget.pd.last.weight != "" &&
                                        int.parse(widget.pd.last.weight) != 0)
                                    ? (int.parse(widget.pd.last.weight) > 99 ||
                                            int.parse(widget.pd.last.weight) <
                                                40)
                                        ? RichText(
                                            text: TextSpan(
                                                text: "Weight- ",
                            ...
                            ListView.builder(
                              itemCount: snapshot.data[index].diagnosis == null
                                  ? 0
                            ...
                            ListView.builder(
                              itemCount: snapshot.data[index].medication == null
                                  ? 0
